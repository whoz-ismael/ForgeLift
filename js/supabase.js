  ...
  window.ForgeLiftAuth = {
    ...
    loadProfile: function () {
      return client.from("profiles")
        .select("machines,logs,unit,theme,lang,routine,day_names,org_mode,routine_lists,onboarded")
        .maybeSingle()
        .then(function (r) {
          ...
          if (!d) return null;
          return {
            machines: d.machines, logs: d.logs, unit: d.unit, theme: d.theme, lang: d.lang,
    ...
    saveProfile: function (userId, data) {
      return client.from("profiles").upsert({
        ...
        unit: data.unit, theme: data.theme, lang: data.lang,
